...
If you just want to deploy it and move on, start with:

- `docs/getting-started.md` – prerequisites and first deploy
- `docs/operations.md` – day-2 tasks (users, nodes, rotation, troubleshooting)
- `docs/architecture.md` – what talks to what, ports, trust boundaries
